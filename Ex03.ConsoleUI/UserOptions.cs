...
namespace Ex03.ConsoleUI
{
    ...
    {
        private static readonly string[] r_MainMenuOptions = { "Add a vehicle to the garage",
            ...
            "EXIT"};
        private static readonly string[] r_LicensePlatesFilterOptions = { "Show all License plates",
        ...
        private static readonly string[] r_VehicleStatusOptions = { "Change to 'In Repair'" ,
            "Change to 'Repaired'", "Change to 'Paid'"};
        private static readonly string[] r_FuelTypes = { "Soler", "Octan98", "Octan96", "Octan95" };
